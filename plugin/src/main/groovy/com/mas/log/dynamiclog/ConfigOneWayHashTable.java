...
public class ConfigOneWayHashTable {
    public final static int HASH_OFFSET = 0;
    public final static int HASH_A = 1;
    public final static int HASH_B = 2;
    private volatile static int tableLength;
     ...
     * @param nTableLength
     */
    private ConfigOneWayHashTable(int nTableLength) {
     ...
     * 返回值：无
     */
    private static void InitCryptTable() {
        int seed = 0x00100001;
        int index1;
        int index2;
        int i;
     ...
     * @return
     */
    public static int HashString(String lpszString, int dwHashType) {
    ...
    static class Single {
        static ConfigOneWayHashTable instance = new ConfigOneWayHashTable(tableLength);
    }
